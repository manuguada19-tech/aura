...
const TERMS = [
  ...
  { h: "11. Reembolsos", p: "Las compras de Aura se procesan mediante Stripe. Los pagos y reembolsos registrados pueden consultarse en <b>Perfil → Pagos y facturas</b>, donde también se descargan los documentos disponibles. Para solicitar la revisión de un cobro, contacta con soporte sin incluir los datos completos de la tarjeta." },
...
function pageHelp() {
  ...
  const body = `
    ...
    <p>Desde Perfil → Pagos y facturas puedes cancelar o reactivar la renovación, ver los movimientos, reintentar cobros pendientes y descargar facturas o documentos de reembolso. Si ves un cargo que no reconoces, contacta con soporte indicando la fecha y el importe, pero nunca los datos completos de la tarjeta.</p>
