...
const FAQ = [
  ...
  { cat: "Cuenta", q: "¿Cómo elimino mi cuenta?", a: "Desde Yo → Eliminar cuenta. La acción es irreversible y tus datos se borran de forma permanente en un plazo máximo de 30 días, salvo los plazos legales aplicables." },
  { cat: "Perfil", q: "¿Cómo edito mi perfil, fotos y biografía?", a: "En Yo → Editar perfil puedes cambiar el nombre visible, biografía, ciudad, profesión, intereses y otros datos. Las imágenes se gestionan por separado desde Yo → Mis fotos." },
  ...
  { cat: "Notificaciones", q: "¿Cómo elijo qué notificaciones recibo?", a: "Ve a Yo → Notificaciones. Allí puedes activar o desactivar por separado los avisos dentro de la app y los push compatibles con tu dispositivo." },
  { cat: "Notificaciones", q: "Activé el push pero no me llegan avisos, ¿qué reviso?", a: "Comprueba el permiso de notificaciones del navegador y que el push siga activo en Yo → Notificaciones. En iPhone, las notificaciones web requieren haber añadido Aura a la pantalla de inicio." },
  ...
  { cat: "Seguridad", q: "¿Cómo reviso los dispositivos con acceso a mi cuenta?", a: "Ve a Yo → Dispositivos activos. Puedes cerrar de forma remota una sesión que no reconozcas y quitar de la lista los dispositivos cuya sesión ya está cerrada." },
  ...
  { cat: "Pagos", q: "¿Qué incluye cada plan?", a: "Cada nivel cambia límites y funciones, como likes, chats nuevos, lecturas, perfiles cercanos, Boost y herramientas del chat. La comparación completa y vigente está en Yo → Suscripción." },
  ...
  { cat: "Pagos", q: "¿Cómo cancelo mi suscripción?", a: "La cancelación automática desde el perfil todavía no está disponible. Solicítala desde Contacto o escribe a suscripciones@citasaura.es indicando el correo de tu cuenta; no envíes datos completos de la tarjeta." },
  { cat: "Pagos", q: "¿Cómo pido una factura o un reembolso?", a: "Solicítalo mediante Contacto o en suscripciones@citasaura.es e indica el correo de la cuenta, la fecha aproximada y el importe. Cada caso se revisa según el medio de pago y la normativa aplicable." },
];
...
const TERMS = [
  ...
  { h: "11. Reembolsos", p: "Las compras de Aura se procesan mediante Stripe. Para solicitar la revisión de un cobro o un posible reembolso, escribe a <b>suscripciones@citasaura.es</b> con el correo de la cuenta, la fecha y el importe, sin incluir los datos completos de la tarjeta." },
...
const PRIVACY = [
  ...
  { h: "5. Destinatarios y encargados del tratamiento", p: "Tus datos podrán ser tratados por encargados o proveedores con contratos de encargo firmados y garantías adecuadas: hosting e infraestructura cloud en la UE, proveedor SMTP europeo para el correo transaccional, proveedor KYC especializado para la verificación de identidad y Stripe como pasarela de pago. No cedemos datos a terceros con fines comerciales ni los vendemos." },
...
function pagePortada() {
  ...
  const body = `
    ...
    <h2>Tus datos</h2>
    <p>Aura está operada desde España y cumple el RGPD. Los datos se alojan en la Unión Europea. No vendemos datos personales ni cedemos tu perfil a terceros para publicidad. Los documentos de identidad se usan para la verificación y se conservan durante el plazo explicado en la política correspondiente. Puedes corregir los datos del perfil o borrar la cuenta desde los ajustes; para solicitar una copia completa, escribe a seguridad@citasaura.es. El borrado se completa en un máximo de 30 días, salvo los plazos legales aplicables. En las páginas de contenido de esta web (guías y preguntas frecuentes) puede haber publicidad; si estás en la Unión Europea, se te pide permiso antes de usar cookies publicitarias y puedes retirarlo cuando quieras desde el enlace «Cookies» del pie. <a href="/privacidad">Política de privacidad</a> · <a href="/terminos">Términos</a></p>

    <h2>Qué es gratis y qué se paga</h2>
    <p>Crear el perfil, verificarte, explorar, hacer match y chatear es gratis, sin límite de tiempo y sin tarjeta. La versión gratuita tiene un tope diario de «me gusta», suficiente para un uso normal. La suscripción <b>Premium</b> quita ese tope, permite deshacer la última valoración y da más visibilidad; los <b>Boost</b> se compran por separado y suben tu perfil al principio de la fila durante un rato. Los precios están dentro de la app, en euros y con el IVA incluido. Mientras se completa la gestión automática desde el perfil, las cancelaciones se solicitan por Contacto o a suscripciones@citasaura.es. <a href="/faq#pagos">Preguntas sobre pagos</a></p>
    ...
    <div class="grid">
      ...
      <div class="card"><h3>No hay letra pequeña en el cobro</h3><p>Nada se cobra sin que lo hayas contratado. Antes de pagar se muestran el importe, la periodicidad y las condiciones; las solicitudes de cancelación se tramitan mediante soporte.</p></div>
    </div>
...
function pageFaq() {
  ...
  return layout({
    ...
    description: "Respuestas claras sobre cuentas, perfiles, filtros, matches, chat, notificaciones, seguridad, funciones extra y pagos en Aura.",
    path: "/faq",
    eyebrow: "Ayuda",
...
function pageHelp() {
  ...
  const body = `
    ...
    <p>La cancelación automática todavía no está disponible dentro del perfil. Pídela desde Contacto o escribe a suscripciones@citasaura.es con el correo de tu cuenta. Si ves un cargo que no reconoces, añade la fecha y el importe exactos, pero nunca los datos completos de la tarjeta. Las solicitudes de factura y reembolso se revisan por el mismo canal.</p>
...
function pageContact() {
  ...
  const body = `
    ...
    <p><b>Seguridad y RGPD</b> es para tus derechos sobre tus datos —acceso, rectificación, portabilidad, supresión, oposición— y para avisarnos de un fallo de seguridad. Para ejercer un derecho no hace falta ningún formulario de pago ni justificar por qué: basta escribir desde el correo de la cuenta y decir qué quieres. Respondemos dentro del plazo del RGPD. El borrado de cuenta está disponible en Yo; la copia o portabilidad de los datos se solicita a seguridad@citasaura.es.</p>
    <p><b>Suscripciones</b> es para facturas, cancelaciones y reembolsos de los pagos procesados por Aura. Indica el correo de la cuenta, la fecha aproximada y el importe, sin incluir datos completos de la tarjeta.</p>
