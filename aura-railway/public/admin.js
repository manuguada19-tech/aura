...
const DESIGN_DEFAULTS = {
  ...
  chat_bubble_style:"rounded", chat_bubble_me:"#ff3b6b", chat_bubble_other:"#1a1c26",
  ...
  logo_mode:"image",
  logo_image:"assets/aura-logo-round.png?v=13",
  logo_image_light:"assets/aura-logo-round-light.png?v=13",
  logo_emoji:"💘",
...
function mcBuildMatchDoc(cfg) {
  ...
  const body = `<div class="${hostClass}" style="${hostStyle}">${gon("content.match.hearts") ? mcHeartsHtml() : ""}
    ...
    <div class="match-cards">
      ...
      <div class="match-heart"${(mAccent || mHeartBg) ? ` style="${mAccent ? `color:${mcEsc(mAccent)};` : ""}${mHeartBg ? `background:${mcEsc(mHeartBg)};box-shadow:0 14px 34px rgba(0,0,0,.28), 0 0 0 1px rgba(0,0,0,.14), inset 0 0 0 2px rgba(0,0,0,.06);` : ""}"` : ""}>${heartFill}</div>
