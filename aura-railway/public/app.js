...
function buildLogoInnerHTML() {
  ...
  if (mode === "image") {
    ...
    const urlLight = _t("content.design.logo_image_light", "assets/aura-logo-round-light.png?v=7");
    const urlDark = _t("content.design.logo_image", "assets/aura-logo-round.png?v=7");
  ...
  root.appendChild(el("div", { class: "discover" }, [
    el("div", { class: "discover-topbar" }, [
      el("span", {
        ...
        "aria-label": "Aura",
        html: `<img src="assets/aura-logo-round.png?v=7" alt="Aura" />`,
      }),
