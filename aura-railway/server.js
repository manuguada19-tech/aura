...
async function seedContentDefaults() {
  const defaults = {
    ...
    "content.design.logo_image": "assets/aura-logo-round.png?v=11",       // URL to custom image (dark theme)
    "content.design.logo_image_light": "assets/aura-logo-round-light.png?v=11", // URL to alt image for light theme
  ...
  try {
    ...
    if (!rows || rows.length === 0) {
      const auraV532 = {
        ...
        "content.design.hero_solid_color": "#14060b",
        "content.design.logo_mode": "image",
        "content.design.logo_image": "assets/aura-logo-round.png?v=11",
        "content.design.logo_image_light": "assets/aura-logo-round-light.png?v=11",
        "content.design.logo_bg": "transparent",
